...
int64 nChainStartTime = 1459340569;
...
const string strMessageMagic = "Gsscoin Signed Message:\n";
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
	...
	nRewardCoinYear = 2.2 * MAX_MINT_PROOF_OF_STAKE;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Gsscoin
    bool fStrictPayToScriptHash = true; // Always active in Gsscoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Gsscoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CBigNum interest empty mapBlockIndex Gsscoin";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 371338 : 371338;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
		assert(block.hashMerkleRoot == uint256("0xa0a4005b126b50263c51bd759ab1e2b69faa7610896d3a5e91a4e466cad743a3"));
...
unsigned char pchMessageStart[4] = { 0xc3, 0xfb, 0xf1, 0xdb };
